...
#### Important update (12/3/2021). #### 
Note well: The original GPU code (from the time of the publication of the paper) has been deprecated. The current code is based on a much faster CUDA implementation, leading usually to #### a x50 speedup.####
